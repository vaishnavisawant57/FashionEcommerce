...
import com.example.fashionecommerce.Model.Cart;
import com.example.fashionecommerce.Prevalent.CartViewHolder;
        ...
        FirebaseRecyclerOptions<Cart> options =
                new FirebaseRecyclerOptions.Builder<Cart>()
                        .setQuery(cartListRef.child("User view")
                                .child(valueOf(Prevalent.currentOnlineUser.getPhone())).child("Products"),Cart.class).build();
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (i==1){
                                    cartListRef.child("User view")
                                            .child(valueOf(Prevalent.currentOnlineUser.getPhone()))
                                            .child("Products")
                                            .child(model.getPid())
                                            .removeValue()
