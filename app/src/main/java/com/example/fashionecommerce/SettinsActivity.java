...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        ref.child(valueOf(Prevalent.currentOnlineUser.getPhone())).updateChildren(userMap);
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(valueOf(Prevalent.currentOnlineUser.getPhone()));
